...
print("Running search + mission + command-wrapper dry-run for", RUN_TIME_SECONDS, "seconds...")
print("No commands should be sent to the Pixhawk.")
print("Testing: SEARCH pattern stops when marker is detected.")
print("Testing: SEARCH -> ACQUIRE -> TRACK -> APPROACH -> LAND -> DISARM.")
print("All generated commands must pass through the safety wrapper.")
...
print("Search + mission + command-wrapper dry-run complete")
